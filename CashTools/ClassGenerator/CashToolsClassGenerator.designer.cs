...
internal class CashToolsClassGenerator {
    ...
    /// Looks up a localized string similar to The input file is required.
    /// </summary>
    internal static string MakeStaticClass {
        get {
            return ResourceManager.GetString("MakeStaticClass", resourceCulture);
        }
    }
    ...
    /// Looks up a localized string similar to The input file is required.
    /// </summary>
    internal static string ClassAccessModifier {
        get {
            return ResourceManager.GetString("ClassAccessModifier", resourceCulture);
        }
    }
    ...
    /// </summary>
    /// 
    internal static string PropertiesOrFields {
        get {
